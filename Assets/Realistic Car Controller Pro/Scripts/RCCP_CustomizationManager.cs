...
/// </summary>
[AddComponentMenu("BoneCracker Games/Realistic Car Controller Pro/Customization/RCCP Customization Manager")]
public class RCCP_CustomizationManager : RCCP_Singleton<RCCP_CustomizationManager> {

    public RCCP_CustomizationApplier vehicle;       //	Current player vehicle.
    public bool autoRegisterPlayerVehicle = true;       //  Auto registers the player vehicle. Current player vehicle will be assigned automatically.
    ...
    private void RCCP_SceneManager_OnVehicleChanged() {
        ...
        if(autoRegisterPlayerVehicle)
            vehicle = RCCP_SceneManager.Instance.activePlayerVehicle.GetComponent<RCCP_CustomizationApplier>();
    ...
    public void SetTarget(RCCP_CustomizationApplier newTarget) {
