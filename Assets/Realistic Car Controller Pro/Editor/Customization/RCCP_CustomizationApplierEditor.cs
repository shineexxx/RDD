...
[CustomEditor(typeof(RCCP_CustomizationApplier))]
public class RCCP_CustomizationApplierEditor : Editor {

    RCCP_CustomizationApplier prop;

    public override void OnInspectorGUI() {

        prop = (RCCP_CustomizationApplier)target;
